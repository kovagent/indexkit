<!-- Canonical CONTRIBUTING for every *kit. Copy verbatim, then replace REPLACE_KIT. -->
# Contributing

Thanks for your interest in indexkit. Bug reports, fixes, and small improvements are welcome.
